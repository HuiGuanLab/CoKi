...
_C.MODEL.ATTRIBUTE.MASK_VALUE = None

_C.MODEL.MULTIHEAD = CN()
_C.MODEL.MULTIHEAD.NUM_HEADS = 8
...
_C.INPUT.MISSING_ATTR_PROB = 0.0
_C.INPUT.MISSING_TEXT_PROB = 0.0
